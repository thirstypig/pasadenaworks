...
export const copy: Partial<Record<CitySlug, CityCopy>> = {
  ...
  glendale: {
    ...
    summary:
      'Glendale carries more registered dentists and primary-care physicians than any other city we cover, along with three general acute care hospitals, so the hard part of practicing here is not being overlooked.',
    body: [
  ...
  alhambra: {
    ...
    summary:
      'Alhambra is the one city we cover where more than a fifth of residents speak Spanish at home and roughly a third speak Chinese. That makes every shift at the front desk a three-language shift.',
    body: [
  ...
  'san-marino': {
    ...
    body: [
      ...
      'With only 37 dentists, optometrists, and primary-care physicians registered in the entire city, there is no large pool of local competitors to take patients from, so growth has to come from the patients you already have and from the cities around you. Get more patients addresses both. It sends recall messages to patients who are overdue for a visit. It also writes the Google Business Profile and the website in English and Chinese, so that a patient weighing a San Marino practice against one in Pasadena or San Gabriel finds the same details in either language.',
    ],
  ...
  'monterey-park': {
    ...
    summary:
      'Monterey Park holds two general acute care hospitals within its limits and more than four in ten of its residents speak Chinese at home, so a practice here competes beside the hospitals and in more than one spoken language.',
    body: [
      'If you run a dental practice in Monterey Park, you are practicing beside two hospitals. California’s HCAI licenses both Garfield Medical Center and Monterey Park Hospital inside the city, and a third, Alhambra Hospital Medical Center, lies nearby in Alhambra; among the cities we cover, only Glendale has more within its own limits. The NPI Registry lists 69 dentists, 62 primary-care physicians, and 27 optometrists with a practice location in Monterey Park, as queried in September 2026. Physicians nearly match dentists there, a mix that is unusual among the cities on this site.',
