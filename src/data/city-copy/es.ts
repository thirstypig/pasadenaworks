...
export const copy: Partial<Record<CitySlug, CityCopy>> = {
  ...
  'south-pasadena': {
    ...
    summary:
      'South Pasadena no tiene un hospital propio, y sus residentes hablan chino y español en casa en proporciones tan parecidas que un consultorio no puede elegir un solo idioma basándose únicamente en las cifras.',
    body: [
      'El Registro NPI, consultado en septiembre de 2026, incluye a 45 dentistas, 12 optometristas y 11 médicos de atención primaria con un lugar de consulta en South Pasadena, de modo que aquí los dentistas superan a los médicos generalistas en una proporción de aproximadamente cuatro a uno. Según el HCAI de California, no hay ningún hospital general de cuidados agudos dentro de la ciudad, sino dos cercanos en ciudades colindantes: Alhambra Hospital Medical Center, en Alhambra, y Huntington Hospital, en Pasadena.',
  ...
  arcadia: {
    ...
    body: [
      'Según el Registro NPI consultado en septiembre de 2026, Arcadia cuenta con 144 dentistas, 100 médicos de atención primaria y 35 optometristas con un lugar de consulta en la ciudad, donde el HCAI de California otorga licencia a un hospital general de cuidados agudos, USC Arcadia Hospital, mientras que otro, Monrovia Memorial Hospital, se ubica en la vecina Monrovia. Por consiguiente, un paciente de Arcadia que busca un dentista puede comparar bastante más de un centenar sin salir de la ciudad.',
  ...
  monrovia: {
    ...
    summary:
      'Monrovia tiene la mayor proporción de hablantes de español de las diez ciudades que cubrimos, cifras pequeñas de dentistas, optometristas y médicos de atención primaria registrados, y un hospital general de cuidados agudos propio.',
    body: [
      'Con datos de septiembre de 2026, el Registro NPI incluye a 25 dentistas, 15 optometristas y 13 médicos de atención primaria con un lugar de consulta en Monrovia, un mercado pequeño situado junto a otro mucho mayor, puesto que la vecina Arcadia registra 144 dentistas y 100 médicos de atención primaria con la misma búsqueda. El HCAI de California otorga licencia a un hospital general de cuidados agudos en la ciudad, Monrovia Memorial Hospital, mientras que USC Arcadia Hospital se encuentra cerca, en Arcadia.',
      'Según las estimaciones de cinco años de 2024 de la Encuesta sobre la Comunidad Estadounidense, el 30.1% de los residentes de Monrovia de cinco años o más habla español en casa, la proporción más alta entre las ciudades que cubrimos, y el 6.7% habla chino. Cuando casi uno de cada tres residentes lo habla, el español no es una concesión que un consultorio de esta ciudad pueda dejar en manos del empleado que casualmente sea bilingüe, sino que debe figurar en el menú de navegación del sitio web, en cada formulario de admisión y de consentimiento, y en la descripción del Perfil de Negocio de Google. La proporción de hablantes de chino justifica una línea que indique si alguien del personal lo habla, aunque es mucho más difícil justificar la traducción de todo un sitio web por esa razón.',
      'Como el mercado mucho mayor de Arcadia está justo al otro lado del límite municipal, un paciente de Monrovia que no consigue respuesta en un consultorio tiene otras opciones a su alcance, así que lo que retiene a ese paciente es un motivo para quedarse y no la falta de alternativas. El motivo más probable es el que ya señalan las cifras de idioma: un consultorio que responde bien en español, en la ciudad con la mayor proporción de hablantes de español que cubrimos, tiene una ventaja que no depende de cuántos consultorios haya en la ciudad vecina. Por consiguiente, el servicio Conseguir más pacientes comienza con una ficha de Google y un sitio web que le indiquen a una persona hispanohablante que llama, en su idioma, si el consultorio acepta su seguro y si está recibiendo pacientes nuevos. Si sospecha que esas personas ya llaman al consultorio y no dejan mensaje, la Revisión integral del consultorio es el punto de partida lógico.',
    ],
  ...
  'san-marino': {
    ...
    body: [
      'Con datos de septiembre de 2026, el Registro NPI incluye a 18 dentistas, 17 médicos de atención primaria y solo 2 optometristas con un lugar de consulta en San Marino, en contraste con los 93 optometristas registrados en la vecina Pasadena, lo que significa que un residente que necesita un examen de la vista dispone de muchas más opciones al otro lado del límite municipal que dentro de su propia ciudad. El HCAI de California no registra ningún hospital general de cuidados agudos en San Marino; los hospitales cercanos son San Gabriel Valley Medical Center, en San Gabriel, y Huntington Hospital, en Pasadena.',
      'Las estimaciones de cinco años de 2024 de la Encuesta sobre la Comunidad Estadounidense indican que el 43.8% de los residentes de San Marino de cinco años o más habla chino en casa, la proporción más alta de todas las ciudades que cubrimos, mientras que solo el 3.2% habla español. A la luz de esas cifras, una versión en chino del sitio web y de los formularios de admisión es menos una cortesía que un segundo idioma de trabajo para el consultorio, en tanto que una traducción al español sería difícil de justificar atendiendo únicamente a la población residente. Sin embargo, no todos los pacientes de un consultorio viven dentro de los límites de la ciudad, de modo que sus propios expedientes deberían decidir si se prescinde por completo del español.',
  ...
  'monterey-park': {
    ...
    body: [
      'El Registro NPI, consultado en septiembre de 2026, incluye a 69 dentistas, 62 médicos de atención primaria y 27 optometristas con un lugar de consulta en Monterey Park, una distribución en la que los médicos prácticamente igualan en número a los dentistas. El HCAI de California otorga licencia a dos hospitales generales de cuidados agudos distintos dentro de la ciudad, Garfield Medical Center y Monterey Park Hospital, y un tercero, Alhambra Hospital Medical Center, se localiza en las cercanías, en Alhambra. Entre las ciudades que cubrimos, solo Glendale cuenta con más hospitales dentro de sus propios límites.',
  ...
  'san-gabriel': {
    ...
    body: [
      'Con datos de septiembre de 2026, el Registro NPI incluye a 106 dentistas, 47 médicos de atención primaria y 31 optometristas con un lugar de consulta en San Gabriel, en comparación con 69 dentistas y 62 médicos de atención primaria registrados en Monterey Park. El HCAI de California otorga licencia a un hospital general de cuidados agudos en la ciudad, San Gabriel Valley Medical Center, y Alhambra Hospital Medical Center está situado en las proximidades, en Alhambra. Un consultorio dental de San Gabriel enfrenta más del doble de competidores registrados dentro de la ciudad que un consultorio de atención primaria, mientras que en Monterey Park ambas especialidades se encuentran prácticamente equilibradas.',
