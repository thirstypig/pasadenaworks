  ...
  /* ── 1. Website development ─────────────────────────────────────────── */
  {
    ...
    t: {
      en: {
        ...
        summary:
          "If your site loads slowly, looks outdated, or doesn't say clearly what you do, people leave and go elsewhere. We build fast, simple sites you actually own when we're done — no hidden fees, no getting locked in.",
        body: [
          '<p>Most small business websites were built once, years ago, by someone who has since stopped answering emails. Meanwhile the customer already left and called the shop down the street.</p>',
          ...
          '<p>You own everything — the site, the domain, the content. No hostage situations.</p>',
        ],
        outcomes: [
      ...
      es: {
        ...
        summary:
          'Si su sitio carga lento, se ve anticuado, o no dice con claridad qué hace, la gente se va a otro lado. Construimos sitios rápidos y simples que usted sí es dueño cuando terminamos — sin cargos ocultos, sin quedar atrapado.',
        body: [
          '<p>La mayoría de los sitios web de negocios pequeños se hicieron una sola vez, hace años, por alguien que ya no contesta los correos. Mientras tanto, el cliente ya se fue y llamó al negocio de la otra cuadra.</p>',
          ...
          '<p>Todo es suyo — el sitio, el dominio, el contenido. Aquí nadie retiene nada.</p>',
        ],
        outcomes: [
      ...
      'zh-hans': {
        ...
        summary:
          '如果网站打开慢、看起来过时，或说不清楚您是做什么的，客人转身就走，去了别家。我们做又快又简单的网站，做完之后完全归您——没有隐藏费用，也不会被绑住。',
        body: [
          '<p>大部分小生意的网站都是很多年前做的，做网站的人早就联系不上了。等客人找了半天，早就转头打给隔壁那家了。</p>',
      ...
      'zh-hant': {
        ...
        summary:
          '如果網站開啟慢、看起來過時，或說不清楚您是做什麼的，客人轉身就走，去了別家。我們做又快又簡單的網站，做完之後完全歸您——沒有隱藏費用，也不會被綁住。',
        body: [
          '<p>大部分小生意的網站都是很多年前做的，做網站的人早就聯絡不上了。等客人找了半天，早就轉頭打給隔壁那家了。</p>',
  ...
  /* ── 2. Organic / SEO ───────────────────────────────────────────────── */
  {
    ...
    t: {
      en: {
        ...
        body: [
          '<p>Somebody within three miles of you is typing your service into their phone right now. The only question is whose name comes up.</p>',
      ...
      es: {
        ...
        body: [
          '<p>En este momento hay alguien a menos de cinco kilómetros escribiendo su servicio en el teléfono. La única pregunta es qué nombre aparece.</p>',
          ...
          '<p>Este trabajo es lento — tres a seis meses antes de que empiece a acumularse, y eso ahora incluye el lado GEO también. Quien le prometa la primera página para el martes le está vendiendo otra cosa.</p>',
        ],
        outcomes: [
      ...
      'zh-hans': {
        ...
        body: [
          '<p>此时此刻，离您几公里之内就有人正在手机上搜索您做的这个行业。唯一的问题是：跳出来的是谁的名字。</p>',
      ...
      'zh-hant': {
        ...
        body: [
          '<p>此時此刻，離您幾公里之內就有人正在手機上搜尋您做的這個行業。唯一的問題是：跳出來的是誰的名字。</p>',
   ...
   *      that keep bringing them. ───────────────────────────────────── */
  {
    ...
    t: {
      en: {
        ...
        body: [
          '<p>Paid advertising is the fastest way to get in front of people, and the fastest way to burn money. Most businesses need some mix of paid and organic — the real question is which mix.</p>',
          ...
          '<p>A plain monthly note either way: what you spent, what it brought back.</p>',
        ],
        outcomes: [
      ...
      es: {
        ...
        body: [
          '<p>La publicidad pagada es la forma más rápida de llegar a la gente, y también la más rápida de quemar dinero. La mayoría de los negocios necesitan una mezcla de pagado y orgánico — la pregunta real es cuál mezcla.</p>',
          ...
          '<p>Una nota mensual clara, de cualquier forma: cuánto gastó, cuánto regresó.</p>',
        ],
        outcomes: [
      ...
      'zh-hans': {
        ...
        body: [
          '<p>付费广告是最快让人看到您的办法，也是最快烧钱的办法。大多数生意需要付费和自然流量的某种组合——真正的问题是哪种组合。</p>',
          ...
          '<p>不管哪种情况，每月都有一份大白话说明：花了多少，带回来多少。</p>',
        ],
        outcomes: [
          '关于「您现在到底适不适合投广告」的实话',
      ...
      'zh-hant': {
        ...
        body: [
          '<p>付費廣告是最快讓人看到您的辦法，也是最快燒錢的辦法。大多數生意需要付費和自然流量的某種組合——真正的問題是哪種組合。</p>',
          ...
          '<p>不管哪種情況，每月都有一份白話說明：花了多少，帶回來多少。</p>',
        ],
        outcomes: [
          '關於「您現在到底適不適合投廣告」的實話',
   ...
   *      call) ────────────────────────────────────────────────────────── */
  {
    ...
    t: {
      en: {
        ...
        body: [
          '<p>Call it a consultancy session, a strategy check-in, or just a second opinion — the label doesn\'t matter. Running a small business means every decision lands on one desk, and there\'s rarely anyone to talk it through with who isn\'t also your spouse or your employee.</p>',
          '<h3>How it works</h3><ul><li>A working session, not a lecture — we look at your numbers together</li><li>Two or three things that actually matter this quarter, named plainly</li><li>A short written summary you can act on, not a slide deck</li></ul>',
          "<p>Sometimes the honest answer is that your business is fine and you don't need us. We'll tell you that too.</p>",
        ],
        outcomes: [
      ...
      es: {
        ...
        body: [
          '<p>Llámelo sesión de consultoría, revisión de estrategia, o simplemente una segunda opinión — el nombre no importa. Tener un negocio pequeño significa que todas las decisiones caen en un solo escritorio, y casi nunca hay con quién platicarlo que no sea su pareja o su empleado.</p>',
          '<h3>Cómo funciona</h3><ul><li>Una sesión de trabajo, no una conferencia: revisamos sus números juntos</li><li>Las dos o tres cosas que de verdad importan este trimestre, dichas con claridad</li><li>Un resumen corto por escrito que usted puede usar, no una presentación</li></ul>',
          '<p>A veces la respuesta honesta es que su negocio está bien y no nos necesita. También se lo vamos a decir.</p>',
        ],
        outcomes: [
      ...
      'zh-hans': {
        ...
        body: [
          '<p>叫它经营咨询也好，战略会谈也好，还是就叫第二意见，名字不重要。做小生意意味着所有决定都压在同一张桌子上，而能商量的人，往往不是您的家人就是您的员工。</p>',
          '<h3>怎么做</h3><ul><li>一次会谈，不是听课——我们一起看您的数字</li><li>挑出这个季度真正要紧的两三件事，说清楚</li><li>一份能直接用的简短书面总结，不是一堆幻灯片</li></ul>',
          '<p>有时候诚实的答案是：您的生意挺好的，不需要我们。这话我们也会照直说。</p>',
        ],
        outcomes: [
          '一次会谈，弄清楚先解决哪件事',
          '看清楚您的收入和时间到底来自哪里',
      ...
      'zh-hant': {
        ...
        body: [
          '<p>叫它經營諮詢也好，策略會談也好，還是就叫第二意見，名字不重要。做小生意意味著所有決定都壓在同一張桌子上，而能商量的人，往往不是您的家人就是您的員工。</p>',
          '<h3>怎麼做</h3><ul><li>一次會談，不是聽課——我們一起看您的數字</li><li>挑出這個季度真正要緊的兩三件事，說清楚</li><li>一份能直接用的簡短書面總結，不是一堆簡報</li></ul>',
          '<p>有時候誠實的答案是：您的生意挺好的，不需要我們。這話我們也會照直說。</p>',
        ],
        outcomes: [
          '一次會談，釐清先解決哪件事',
          '看清楚您的收入和時間到底來自哪裡',
