    ...
    t: {
      ...
      es: {
        ...
        body: [
          ...
          `<h2>Tres desenlaces, y usted elige</h2><ul><li><strong>Vender el consultorio.</strong> Lo preparamos para la venta: expedientes digitalizados y organizados, procedimientos por escrito, datos de pacientes precisos y una recepción que funciona un día cualquiera sin usted. La venta en sí corresponde a los profesionales con licencia que usted contrate.</li><li><strong>Entregarlo a un médico asociado o a un sucesor.</strong> Planificamos el traspaso para que los sistemas, los procedimientos y la confianza de los pacientes permanezcan en el consultorio en lugar de irse con usted.</li><li><strong>Cerrarlo como se debe.</strong> Planificamos las cartas a los pacientes, la transferencia de los expedientes y los perfiles en directorios que deben darse de baja, y revisamos las normas de su profesión; California, por ejemplo, exige que un médico conserve los expedientes clínicos de sus pacientes <a href="${SOURCES.calBusProf2266}">durante al menos siete años después de la última consulta</a>, y que un optometrista los conserve <a href="${SOURCES.calBusProf3007}">durante siete años después de terminado el tratamiento y, en el caso de un menor, hasta que cumpla diecinueve años</a>.</li></ul>`,
        ...
        outcomes: [
          ...
          'Asesoría de alguien a quien le paga el consultorio, sin que su pago dependa del desenlace',
        ],
      ...
      'zh-hans': {
        ...
        body: [
          ...
          `<h2>三种结局，由您选择</h2><ul><li><strong>出售诊所。</strong>我们为出售做好准备：病历完成数字化并妥善整理、工作流程形成书面文件、患者资料准确无误，以及一个在寻常日子里没有您也能正常运作的前台。出售本身则由您所委任的持照专业人士负责。</li><li><strong>交由聘任医生或接班人接手。</strong>我们规划交接过程，让系统、工作流程与患者的信任留在诊所，而非随您一同离开。</li><li><strong>妥善结业。</strong>我们规划致患者的通知信、病历的移交，以及必须撤下的各类网上名录资料，并核对您所属专业的相关规定；以加州为例，医生须将患者病历<a href="${SOURCES.calBusProf2266}">自最后一次就诊起至少保存七年</a>，验光师则须<a href="${SOURCES.calBusProf3007}">自治疗结束起保存七年，未成年人的病历须保存至其年满十九岁</a>。</li></ul>`,
