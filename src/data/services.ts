   ...
   *  transition-sources.md marks Verified. services.test.ts enforces both. */
  {
    ...
    t: {
      ...
      es: {
        ...
        body: [
          '<p>La mayoría de los doctores empieza a planificar su salida unos pocos meses antes de la fecha en que piensa irse, que es más o menos el momento en que ya resulta demasiado tarde para cambiar algo que de verdad importe. Un consultorio que todavía funciona con expedientes en papel, con procedimientos que solo existen en la memoria de quien lo administra y con una recepción que solo una persona entiende por completo es más difícil de vender, más difícil de entregar a un sucesor y más difícil de cerrar sin dejar desamparados a los pacientes, y como cada uno de esos problemas tarda meses en resolverse, el plan vale más cuanto antes se elabora.</p>',
          `<h2>Tres desenlaces, y usted elige</h2><ul><li><strong>Vender el consultorio.</strong> Lo preparamos para la venta: expedientes digitalizados y organizados, procedimientos por escrito, datos de pacientes precisos y una recepción que funciona un día cualquiera sin usted. La venta en sí corresponde a los profesionales con licencia que usted contrate.</li><li><strong>Entregarlo a un profesional asociado o a un sucesor.</strong> Planificamos el traspaso para que los sistemas, los procedimientos y la confianza de los pacientes permanezcan en el consultorio en lugar de irse con usted.</li><li><strong>Cerrarlo como se debe.</strong> Planificamos las cartas a los pacientes, la transferencia de los expedientes y los perfiles en directorios que deben darse de baja, y revisamos las normas de su profesión; California, por ejemplo, exige que un médico conserve los expedientes clínicos de sus pacientes <a href="${SOURCES.calBusProf2266}">durante al menos siete años después de la última consulta</a>, y que un optometrista los conserve <a href="${SOURCES.calBusProf3007}">durante al menos siete años después de terminado el tratamiento y, en el caso de un menor, como mínimo hasta que cumpla diecinueve años</a>.</li></ul>`,
        ...
        outcomes: [
          ...
          'Expedientes clínicos digitalizados, organizados y listos para pasar a un comprador, a un sucesor o a un custodio de expedientes',
          'Procedimientos escritos que permiten que la recepción funcione un día cualquiera sin usted',
          'Un calendario para las cartas a los pacientes, los cambios en los directorios y la transferencia de expedientes, revisado según las normas de su profesión',
          'Una definición clara de qué decisiones corresponden a su abogado y cuáles a su contador, para que nada quede sin atender entre uno y otro',
