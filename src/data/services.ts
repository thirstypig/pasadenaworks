    ...
    t: {
      en: {
        ...
        body: [
          ...
          "<p>Sometimes the honest answer is that your online presence is already working fine. We'll tell you that too.</p>",
        ],
        outcomes: [
      ...
      es: {
        ...
        body: [
          ...
          '<p>A veces la respuesta honesta es que su presencia en línea ya funciona bien. También se lo vamos a decir.</p>',
        ],
        outcomes: [
      ...
      'zh-hans': {
        ...
        summary:
          '不确定该投资新网站、提升谷歌曝光，还是投放付费广告？我们一起看看您的线上工作，诚实地告诉您什么真正值得做——什么可以先放一放。',
        body: [
          '<p>叫它经营咨询也好，战略会谈也好，还是就叫第二意见，名字不重要。这不是一般的经营咨询，而是专门针对您的线上呈现——您的网站、您的曝光度、您的营销——以及该怎么安排顺序、怎么落地。</p>',
          '<h3>怎么做</h3><ul><li>一次会谈，不是听课——我们一起看您的网站、搜索曝光和广告到底是什么情况</li><li>帮您决定接下来该在线上投资什么，什么可以先放着不管</li><li>一份能直接用的简短书面总结，不是一堆幻灯片</li></ul>',
          '<p>有时候诚实的答案是：您的线上呈现已经很好了，不需要我们。这话我们也会照直说。</p>',
        ],
        outcomes: [
          '一次会谈，弄清楚线上先解决哪件事',
          '看清楚您哪些线上投入真正有回报',
      ...
      'zh-hant': {
        ...
        summary:
          '不確定該投資新網站、提升 Google 曝光，還是投放付費廣告？我們一起看看您的線上工作，誠實地告訴您什麼真正值得做——什麼可以先放一放。',
        body: [
          '<p>叫它經營諮詢也好，策略會談也好，還是就叫第二意見，名字不重要。這不是一般的經營諮詢，而是專門針對您的線上呈現——您的網站、您的曝光度、您的行銷——以及該怎麼安排順序、怎麼落地。</p>',
          '<h3>怎麼做</h3><ul><li>一次會談，不是聽課——我們一起看您的網站、搜尋曝光和廣告到底是什麼情況</li><li>幫您決定接下來該在線上投資什麼，什麼可以先放著不管</li><li>一份能直接用的簡短書面總結，不是一堆簡報</li></ul>',
          '<p>有時候誠實的答案是：您的線上呈現已經很好了，不需要我們。這話我們也會照直說。</p>',
        ],
        outcomes: [
          '一次會談，釐清線上先解決哪件事',
          '看清楚您哪些線上投入真正有回報',
