    ...
    t: {
      en: {
        ...
        body: [
          ...
          `<h2>Three endings, and you choose</h2><ul><li><strong>Selling the practice.</strong> Although the transaction itself belongs to the licensed professionals you engage, we prepare the practice for it: records digitized and organized, documented procedures, accurate patient data, and a front office that operates on an ordinary day without you.</li><li><strong>Handing it on to an associate or successor.</strong> We plan the handover so that the systems, the procedures, and the patients’ trust remain with the practice rather than leaving with you.</li><li><strong>Closing the practice properly.</strong> We plan the patient letters, the transfer of records, and the directory listings that must be removed, and we review the regulations that govern your profession; California, for example, requires a physician to keep patient records <a href="${SOURCES.calBusProf2266}">for at least seven years after the last visit</a>, and an optometrist <a href="${SOURCES.calBusProf3007}">for at least seven years after treatment ends, and for a minor at least until age nineteen</a>.</li></ul>`,
      ...
      es: {
        ...
        outcomes: [
          ...
          'Asesoría de alguien a quien le paga el consultorio y cuyos honorarios no dependen del desenlace',
        ],
