   ...
   *  transition-sources.md marks Verified. services.test.ts enforces both. */
  {
    ...
    t: {
      en: {
        ...
        body: [
          '<p>Most doctors begin planning their departure only a few months before they intend to leave, which is approximately the moment when it becomes too late to change anything of real consequence. A practice that still operates on paper charts, on procedures that exist only in the office manager’s memory, and on a front desk that only one employee fully understands is harder to sell, harder to transfer to a successor, and harder to close without leaving patients stranded, and because each of those deficiencies takes months to correct, the plan is most valuable when it is prepared early.</p>',
          `<h2>Three endings, and you choose</h2><ul><li><strong>Selling the practice.</strong> Although the transaction itself belongs to the licensed professionals you engage, we prepare the practice for it: records digitized and organized, documented procedures, accurate patient data, and a front office that operates on an ordinary day without you.</li><li><strong>Handing it on to an associate or successor.</strong> We plan the handover so that the systems, the procedures, and the patients’ trust remain with the practice rather than departing with you.</li><li><strong>Closing the practice properly.</strong> We plan the patient letters, the transfer of records, and the directory listings that must be removed, and we review the regulations that govern your profession; California, for example, requires a physician to keep patient records <a href="${SOURCES.calBusProf2266}">for at least seven years after the last visit</a>, and an optometrist <a href="${SOURCES.calBusProf3007}">for at least seven years after treatment ends, and for a minor at least until age nineteen</a>.</li></ul>`,
          '<p>We do not value practices, find or negotiate with buyers, or give legal or tax advice, because those decisions belong to your attorney, your accountant, and the licensed professionals you engage. What we contribute is the operational preparation that simplifies each of their responsibilities, and since we are paid by the practice and by nobody else, our advice does not depend on which ending you choose.</p>',
        ],
        outcomes: [
          'A written transition plan that identifies the ending you have chosen, the steps it requires, and the sequence in which to take them',
          ...
          'A timeline for patient letters, directory changes, and record transfers, checked against the regulations that govern your profession',
          ...
          'Advice from someone who is compensated by the practice and not by the outcome',
        ],
      ...
      es: {
        ...
        body: [
          '<p>La mayoría de los doctores empieza a planificar su salida solo unos pocos meses antes de la fecha en que piensa irse, que es aproximadamente el momento en que ya resulta demasiado tarde para cambiar algo de verdadera trascendencia. Un consultorio que todavía opera con expedientes en papel, con procedimientos que solo existen en la memoria de quien lo administra y con una recepción que solo un empleado entiende por completo es más difícil de vender, más difícil de traspasar a un sucesor y más difícil de cerrar sin dejar desamparados a los pacientes, y como cada una de esas deficiencias tarda meses en corregirse, el plan resulta más valioso cuanto antes se elabora.</p>',
          `<h2>Tres desenlaces, y usted elige</h2><ul><li><strong>Vender el consultorio.</strong> Aunque la operación de venta en sí corresponde a los profesionales con licencia que usted contrate, preparamos el consultorio para ella: expedientes digitalizados y organizados, procedimientos documentados, datos de pacientes precisos y una recepción que opera un día cualquiera sin usted.</li><li><strong>Entregarlo a un profesional asociado o a un sucesor.</strong> Planificamos el traspaso para que los sistemas, los procedimientos y la confianza de los pacientes permanezcan en el consultorio en lugar de irse con usted.</li><li><strong>Cerrar el consultorio como se debe.</strong> Planificamos las cartas a los pacientes, la transferencia de los expedientes y los perfiles en directorios que deben darse de baja, y revisamos las normas que rigen su profesión; California, por ejemplo, exige que un médico conserve los expedientes clínicos de sus pacientes <a href="${SOURCES.calBusProf2266}">durante al menos siete años después de la última consulta</a>, y que un optometrista los conserve <a href="${SOURCES.calBusProf3007}">durante al menos siete años después de terminado el tratamiento y, en el caso de un menor, como mínimo hasta que cumpla diecinueve años</a>.</li></ul>`,
          '<p>No valuamos consultorios, no buscamos compradores ni negociamos con ellos, y no damos asesoría legal ni fiscal, porque esas decisiones corresponden a su abogado, a su contador y a los profesionales con licencia que usted contrate. Lo que aportamos es la preparación operativa que simplifica las responsabilidades de cada uno de ellos, y como nos paga el consultorio y nadie más, nuestra asesoría no depende del desenlace que usted elija.</p>',
        ],
        outcomes: [
          'Un plan de transición por escrito que identifica el desenlace que usted eligió, los pasos que requiere y la secuencia en que conviene darlos',
          ...
          'Un calendario para las cartas a los pacientes, los cambios en los directorios y la transferencia de expedientes, revisado según las normas que rigen su profesión',
          ...
          'Asesoría de alguien a quien remunera el consultorio y cuyos honorarios no dependen del desenlace',
        ],
      ...
      'zh-hans': {
        ...
        body: [
          '<p>多数医生在打算离开前的几个月才开始规划退出，而此时大致已来不及改变任何真正重要的事情。一家仍依赖纸质病历、仅存于诊所经理记忆中的工作流程，以及只有一个人完全了解的前台来运作的诊所，更难出售、更难交给接班人，也更难在不让患者求助无门的情况下结业；由于上述每一个问题都需要数月才能修补，因此这份计划越早制定，价值就越高。</p>',
          `<h2>三种结局，由您选择</h2><ul><li><strong>出售诊所。</strong>我们为出售做好准备：病历完成数字化并妥善整理、工作流程形成书面文件、患者资料准确无误，以及一个在寻常日子里没有您也能正常运作的前台。出售本身则由您所委任的持照专业人士负责。</li><li><strong>交由聘任医生或接班人接手。</strong>我们规划交接过程，让系统、工作流程与患者的信任留在诊所，而非随您一同离开。</li><li><strong>妥善结业。</strong>我们规划致患者的通知信、病历的移交，以及必须撤下的各类网上名录资料，并核对您所属专业的相关规定；以加州为例，医生须将患者病历<a href="${SOURCES.calBusProf2266}">自最后一次就诊起至少保存七年</a>，验光师则须<a href="${SOURCES.calBusProf3007}">自治疗结束起至少保存七年，未成年人的病历并须至少保存至其年满十九岁</a>。</li></ul>`,
        ...
        outcomes: [
          ...
          '一份涵盖致患者通知信、名录资料变更与病历移交的时间表，并已依您所属专业的规定核对',
          '清楚说明哪些决定属于您的律师、哪些属于您的会计师，使任何事项都不致在两者之间被遗漏',
          '由诊所支付报酬、且报酬不取决于最终结局的专业建议',
        ],
      ...
      'zh-hant': {
        ...
        body: [
          '<p>多數醫師在打算離開前的幾個月才開始規劃退場，而此時大致已來不及改變任何真正重要的事情。一家仍仰賴紙本病歷、僅存於診所經理記憶中的作業流程，以及只有一個人完全了解的櫃檯來運作的診所，更難出售、更難交給接班人，也更難在不讓病患求助無門的情況下歇業；由於上述每一個問題都需要數月才能修補，因此這份計畫越早擬定，價值就越高。</p>',
          `<h2>三種結局，由您選擇</h2><ul><li><strong>出售診所。</strong>我們為出售做好準備：病歷完成數位化並妥善整理、作業流程形成書面文件、病患資料正確無誤，以及一個在平常日子裡沒有您也能正常運作的櫃檯。出售本身則由您所委任的持照專業人士負責。</li><li><strong>交由受聘醫師或接班人接手。</strong>我們規劃交接過程，讓系統、作業流程與病患的信任留在診所，而非隨您一同離開。</li><li><strong>妥善歇業。</strong>我們規劃致病患的通知信、病歷的移交，以及必須撤下的各類網路名錄資料，並核對您所屬專業的相關規定；以加州為例，醫師須將病患病歷<a href="${SOURCES.calBusProf2266}">自最後一次就診起至少保存七年</a>，驗光師則須<a href="${SOURCES.calBusProf3007}">自治療結束起至少保存七年，未成年人的病歷並須至少保存至其年滿十九歲</a>。</li></ul>`,
        ...
        outcomes: [
          ...
          '一份涵蓋致病患通知信、名錄資料變更與病歷移交的時程表，並已依您所屬專業的規定核對',
          '清楚說明哪些決定屬於您的律師、哪些屬於您的會計師，使任何事項都不致在兩者之間遭到遺漏',
          '由診所支付報酬、且報酬不取決於最終結局的專業建議',
        ],
