---
title: "Chino simplificado o tradicional: ¿cuál necesita tu consultorio?"
description: "El chino simplificado y el tradicional no son intercambiables en una página web ni en un formulario de admisión. Cómo un consultorio del San Gabriel Valley averigua cuál leen de verdad sus pacientes."
...
> **En corto** — El chino simplificado (简体) es el que utiliza China continental. El chino tradicional (繁體) es el que utilizan Taiwán, Hong Kong, Macao y numerosas comunidades chino-estadounidenses de mayor antigüedad. Si desconoce cuál de los dos leen sus pacientes, pregúnteles, antes que suponerlo sobre la base de que son "chinos". Equivocarse, o mezclar ambos en una misma página, se lee como descuido ante un lector nativo, y no como neutralidad.

Si un paciente de Monterey Park o Alhambra va a leer su sitio web — o, con mayores consecuencias, su formulario de admisión — en chino, usted necesita saber en cuál chino. El simplificado y el tradicional no constituyen dos tipografías ni dos estilos de un mismo idioma: son dos sistemas de escritura distintos para la misma lengua hablada, y una página que los mezcla aparenta haber sido ensamblada por alguien a quien no le importó lo suficiente como para comprobarlo. Ése es precisamente el efecto contrario al que desea dejar en alguien que está decidiendo si confiarle su atención médica.
...
Un lector con fluidez en uno puede frecuentemente descifrar el otro, de modo muy semejante a como un angloparlante suele resolver la ortografía británica frente a la estadounidense. Pero "poder descifrarlo" no constituye el listón de un formulario de consentimiento. Un lector nativo advierte la discordancia al instante, y el efecto no resulta neutral: se lee como prueba de que este consultorio ignora a quién se está dirigiendo. Cuando el documento en cuestión explica un procedimiento o un medicamento, resultar aproximadamente legible no es el estándar al que nadie debería aspirar.
...
## Cómo averiguar cuál usan realmente sus pacientes

No resuelva esto consultando un mapa y suponiendo. Pregunte a sus pacientes reales, o examine de dónde están llegando ya — sus propios registros describen quién entra por la puerta, cosa que un promedio municipal no puede hacer.
...
* Pacientes que mencionan Taiwán, Hong Kong o Macao, o cuyos nombres se romanizan en Wade-Giles o en la grafía hongkonesa antes que en hanyu pinyin.
* Señalización o formularios existentes en su consultorio ya redactados en tradicional, lo cual constituye prueba sólida de que sus pacientes actuales lo leen, y cambiarlo confundiría a la gente antes que ayudarla.
...
* Pacientes cuyos nombres se romanizan en hanyu pinyin, que constituye el sistema estándar del continente.
* Una cartera de pacientes que se inclina hacia lo más joven y lo llegado más recientemente.

Ninguno de los dos conjuntos constituye una regla férrea, y la única manera de saberlo con certeza consiste en preguntar. Si cuenta con pacientes o personal chinohablante, pregúnteles directamente cuál leen con comodidad — y pregunte a varias personas antes que a una sola, puesto que el origen de un individuo no equivale al de su cartera entera. Si está construyendo esto antes de disponer de pacientes a quienes preguntar, examine la señalización y los materiales de los consultorios comparables más cercanos en el barrio que pretende atender.

## Cuando la respuesta es "ambos"

Numerosos consultorios del San Gabriel Valley atienden genuinamente a ambas comunidades: un dentista en Alhambra, un optometrista que cubre desde Monterey Park hasta Arcadia, un médico de familia con pacientes por toda la región. En esa circunstancia, construya ambos, como páginas traducidas enteramente separadas, antes que una sola página con un conmutador que sustituya un puñado de palabras.
...
Un punto adicional merece enunciarse con claridad: ni el simplificado ni el tradicional le sirven de nada si las palabras mismas no son chino auténtico y natural, porque el registro y las elecciones léxicas que Taiwán emplea para un término clínico con frecuencia no son las que emplea China continental, con total independencia del conjunto de caracteres. Una traducción literal, o una producida por alguien fluido en la otra variedad regional, se lee ligeramente desviada del mismo modo en que un "solicitor" británico suena peculiar en publicidad de Los Ángeles. Si va a pagar por una traducción, asegúrese de que quien la realice esté traduciendo al chino regional específico que sus pacientes efectivamente leen, y no meramente al conjunto de caracteres.
