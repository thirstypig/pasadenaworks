---
title: Qué le ocurre a su sitio cuando la empresa de su desarrollador se disuelve
description: "El alojamiento sigue funcionando hasta que una tarjeta se rechaza. El dominio sigue funcionando hasta que una renovación falla. Ambos están en la cuenta de otra persona, y el reloj ya corre."
pubDate: 2027-10-25T00:00:00.000Z
pillar: consulting
targetKeyword: mi desarrollador web cerro que hago
...
> **En resumen** — Nada se rompe el día en que un proveedor cierra, y eso precisamente lo vuelve peligroso. El sitio sigue sirviéndose y el correo sigue llegando hasta que un pago falla o una renovación caduca, ambos según un calendario que nadie vigila. Establezca dentro de la semana qué registrador tiene el dominio, cuándo expira, y si usted puede iniciar sesión, porque un dominio que caduca y completa su ciclo de expiración regresa a disponibilidad general, y llegado ese punto usted está negociando una compra antes que recuperando un activo.

Que un proveedor cierre difiere de que un proveedor se quede callado, y resulta peor en un aspecto concreto: a menudo no queda nadie a quien preguntar, y las cuentas ignoran que su titular ha dejado de operar.

## Por qué al principio parece no ocurrir nada
...
## Las tres cosas que establecer esta semana
...
## Por qué el dominio es lo urgente

Lo demás resulta reemplazable y el dominio no, razón por la cual va primero al margen de qué otra cosa esté ocurriendo.

Un dominio caducado atraviesa un periodo de gracia, después un periodo de redención que acarrea una tarifa sustancial, y después la eliminación, tras la cual regresa a disponibilidad general y cualquiera puede registrarlo, incluidas personas que vigilan nombres que expiran para revenderlos. La OMPI ha administrado 84.743 disputas de dominios desde 1999 y la vía formal existe, y aborda registros de mala fe de nombres que coinciden con una marca, no el caso ordinario de un nombre que simplemente caducó y fue recogido.

De modo que el momento barato es ahora, y el momento caro llega dentro de unos meses.
