...
It is a fair question and the answer is not "because you are not Trader Joe's", and the answer is that the specific thing generating their word of mouth is a structural position, and that position is worth examining, because parts of it are available to a small business and the headline conclusion is not.

## What the numbers actually describe

The scale involved is easy to underestimate, and it changes what "word of mouth" even means.
...
A single-location business trying to run this strategy is missing three things, and each of them matters.
...
Trader Joe's does not advertise because it does not need to, and the reasons it does not need to took fifty years and several hundred stores to build.

Admiring the strategy is entirely reasonable, whereas adopting its conclusion from a single location in year three amounts to adopting the one part of it that was never available to you in the first place.

**Sources:** [Wikipedia, Trader Joe's](https://en.wikipedia.org/wiki/Trader_Joe%27s) · [Google Business Profile Help, Tips to improve your local ranking on Google](https://support.google.com/business/answer/7091?hl=en)
