---
title: 'What owners report about their websites: the survey data'
description: 'An independent survey of 521 small businesses found 82% have a website, and that cost has largely stopped being the reason the rest do not. Read with the sampling caveat stated.'
pubDate: 2027-12-13T00:00:00.000Z
pillar: consulting
targetKeyword: small business website statistics survey
...
> **TL;DR** — The NFIB Research Center surveyed 521 small businesses in March 2025 and found 82% have a website, rising steeply with headcount: 75% at 1–9 employees, 90% at 10–24, 96% at 25–49, 97% above 50. The finding that matters most is what changed: cost was the main barrier for only 16% of those without a site, down from 26% in 2018. Note the sampling limit before quoting any of it — the sample was drawn from NFIB's own membership, not from all US small businesses.

Most "statistics" articles about small business websites are assembled from other statistics articles, and the numbers acquire authority by repetition rather than by measurement. This one uses a survey with a stated method, and states the method's weakness too.

## What was actually measured

The NFIB Research Center fielded a Small Business and Technology Survey by email to a random sample of 20,000 small business owners drawn from its membership database, between **6 and 31 March 2025**, and **521** completed it.
...
It does not tell you what a website should cost, and no survey does, because the question is not answerable in the abstract.

What the data supports is narrower and still useful: near-universal adoption above a handful of employees, a cost barrier that has substantially receded, and therefore a decision that is now about what the site should do rather than whether to have one at all.

**Sources:** [NFIB, How Small Businesses Incorporate Tech and AI Advancements (Small Business and Technology Survey, 2025)](https://www.nfib.com/news/press-release/new-nfib-report-how-small-businesses-incorporate-tech-and-ai-advancements/) · [Pew Research Center, Google users are less likely to click on links when an AI summary appears](https://www.pewresearch.org/short-reads/2025/07/22/google-users-are-less-likely-to-click-on-links-when-an-ai-summary-appears-in-the-results/)
