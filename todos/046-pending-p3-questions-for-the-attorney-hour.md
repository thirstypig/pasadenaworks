...
# Four questions to bring to the hour with a healthcare attorney
...
- **(c) "Worth more when you step back."** `src/pages/index.astro:68-69` says a
  ...
  buyer outreach — stay clear of California's business-broker licensing?
...
### Option B — Soften the four passages now, before the hour

For example, drop "every patient" from the texting line, add "most" to the BAA
definition, and remove the sale-price implication.
...
- `src/pages/index.astro:66-71` and its localized twin in `src/data/home.ts`
- `src/data/glossary.ts:88-91`

## Acceptance Criteria

- [ ] Each of (a)–(d) has a recorded answer from the attorney
