...
| `ocrTrackingTech` | https://www.hhs.gov/hipaa/for-professionals/privacy/guidance/hipaa-online-tracking/index.html | HHS's bulletin on tracking technologies (Dec. 2022, updated Mar. 2024). *AHA v. Becerra* (N.D. Tex., June 20, 2024) vacated only its "Proscribed Combination" — an IP address plus a visit to an unauthenticated public page about a health condition; the page now carries that notice, and HHS dropped its appeal Aug. 29, 2024. The copy's claim concerns pages where patients enter information, which the vacatur did not reach. Moved here from the Holland & Knight summary on 2026-09-15 so the link sits on the primary source (`todos/045`). | WebSearch confirming the URL and the vacatur notice; Holland & Knight and Proskauer summaries (WebFetch) |
